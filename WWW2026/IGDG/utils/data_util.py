...
def load_data(args):
    ...
    if "collab" in dataset:
    ...
    elif "mathoverflow" in dataset:
        from ..data_configs.my_mathoverflow import (
            testlength,
            vallength,
            length,
            processed_datafile_ori,
    ...
    elif "bitcoinOTC" in dataset:
        from ..data_configs.bitcoinOTC import (
            testlength,
            vallength,
            length,
            processed_datafile_ori,
        ...
        if "evasive" in dataset:
            ...
            args.nfeat = data["x"].shape[1]
            args.num_nodes = len(data["x"])
    elif "resistance" == dataset:
        from ..data_configs.resistance import (
            testlength,
            vallength,
            length,
            processed_datafile_ori,
        ...
        args.nfeat = data["x"].shape[1]
        args.num_nodes = len(data["x"])
    elif "resistance_node" == dataset:
        from ..data_configs.resistance_node import (
            testlength,
            vallength,
            length,
            processed_datafile_ori,
        ...
        args.nfeat = data["x"].shape[1]
        args.num_nodes = len(data["x"])
    elif "traffic" == dataset:
        from ..data_configs.traffic import (
            testlength,
            vallength,
            length,
            processed_datafile_ori,
        ...
        from ..data_configs.github import (
            testlength,
            vallength,
            length,
            processed_datafile_ori,
        ...
        args.nfeat = data["x"].shape[1]
        args.num_nodes = len(data["x"])
    elif "elliptic" == dataset:
        from ..data_configs.Elliptic import (
            testlength,
            vallength,
            length,
            processed_datafile_ori,
        ...
        args.nfeat = data["x"].shape[1]
        args.num_nodes = len(data["x"])
    elif "mooc_node" == dataset:
        from ..data_configs.mooc_node import (
            testlength,
            vallength,
            length,
            processed_datafile_ori,
        ...
        args.nfeat = data["x"].shape[1]
        args.num_nodes = len(data["x"])
    elif "elliptic_node" == dataset:
        from ..data_configs.elliptic_node import (
            testlength,
            vallength,
            length,
            processed_datafile_ori,
        ...
        args.nfeat = data["x"].shape[1]
        args.num_nodes = len(data["x"])
    elif "github_node" == dataset:
        from ..data_configs.github_node import (
            testlength,
            vallength,
            length,
            processed_datafile_ori,
        ...
        args.nfeat = data["x"].shape[1]
        args.num_nodes = len(data["x"])
    elif "reddit_node" == dataset:
        from ..data_configs.reddit_node import (
            testlength,
            vallength,
            length,
            processed_datafile_ori,
        ...
        args.nfeat = data["x"].shape[1]
        args.num_nodes = len(data["x"])
    elif "wikipedia_node" == dataset:
        from ..data_configs.wikipedia_node  import (
            testlength,
            vallength,
            length,
            processed_datafile_ori,
